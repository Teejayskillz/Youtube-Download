...
class FOXIE(AdobePassIE):
    ...
    _TESTS = [{
        # clip
        'url': 'https://www.fox.[REDACTED_AWS_SECRET_ACCESS_KEY]e8/',
        ...
        'url': 'https://www.fox.[REDACTED_AWS_SECRET_ACCESS_KEY]c1/',
        'only_matching': True,
    }, {
        # episode, geo-restricted, tv provided required
        'url': 'https://www.fox.[REDACTED_AWS_SECRET_ACCESS_KEY]24/',
        'only_matching': True,
    }]
    _GEO_BYPASS = False
