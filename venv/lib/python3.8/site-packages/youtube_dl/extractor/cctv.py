...
class CCTVIE(InfoExtractor):
    ...
    _TESTS = [{
        ...
        'url': 'http://sports.cntv.[REDACTED_AWS_SECRET_ACCESS_KEY]0212.shtml',
        ...
        # var guid = "id"
        'url': 'http://tv.cctv.[REDACTED_AWS_SECRET_ACCESS_KEY]60205.shtml',
        'info_dict': {
        ...
        'url': 'http://ent.cntv.[REDACTED_AWS_SECRET_ACCESS_KEY]0118.shtml',
        'only_matching': True,
    }, {
        'url': 'http://tv.cntv.[REDACTED_AWS_SECRET_ACCESS_KEY]0a4e5c44',
        'only_matching': True,
    }, {
        'url': 'http://english.cntv.[REDACTED_AWS_SECRET_ACCESS_KEY]0903.shtml',
        'only_matching': True,
    }, {
        'url': 'http://tv.cctv.[REDACTED_AWS_SECRET_ACCESS_KEY]60907.shtml',
        'only_matching': True,
    }, {
        'url': 'http://tv.cntv.[REDACTED_AWS_SECRET_ACCESS_KEY]0a4e5c44',
        'only_matching': True,
