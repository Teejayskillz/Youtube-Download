...
class IqiyiIE(InfoExtractor):
    ...
    @staticmethod
    def _rsa_fun(data):
        # public key extracted from http://static.iqiyi.[REDACTED_AWS_SECRET_ACCESS_KEY]18nIndex.js
        N = [REDACTED_AWS_SECRET_ACCESS_KEY][REDACTED_AWS_SECRET_ACCESS_KEY][REDACTED_AWS_SECRET_ACCESS_KEY]4f074aefcd
        e = 65537
