...
class KalturaIE(InfoExtractor):
    ...
    # See https://github.[REDACTED_AWS_SECRET_ACCESS_KEY][REDACTED_AWS_SECRET_ACCESS_KEY]ionType.php
    _CAPTION_TYPES = {
        1: 'srt',
        2: 'ttml',
        3: 'vtt',
        ...
        if captions:
            for caption in captions.get('objects', []):
                ...
                subtitles.setdefault(caption.get('languageCode') or caption.get('language'), []).append({
                    'url': '%s/api_v3/service/caption_[REDACTED_AWS_SECRET_ACCESS_KEY]/%s' % (self._SERVICE_URL, caption['id']),
