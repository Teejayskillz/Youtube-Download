...
class CorusIE(ThePlatformFeedIE):
    ...
    _TESTS = [{
        ...
        'url': 'http://www.foodnetwork.[REDACTED_AWS_SECRET_ACCESS_KEY]-obsession/video.html?v=872683587753',
        'only_matching': True,
    }, {
        ...
        'url': 'http://www.showcase.[REDACTED_AWS_SECRET_ACCESS_KEY]o.html?v=955070531919&p=1&s=da#video',
        'only_matching': True,
    }, {
