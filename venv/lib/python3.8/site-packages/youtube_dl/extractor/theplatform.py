...
class ThePlatformIE(ThePlatformBaseIE, AdobePassIE):
    ...
    _TESTS = [{
        ...
        'url': 'http://player.theplatform.[REDACTED_AWS_SECRET_ACCESS_KEY]r_ZT7',
        'only_matching': True,
    }, {
        ...
        'url': 'http://player.theplatform.com/p/NnzsPC/onsite_[REDACTED_AWS_SECRET_ACCESS_KEY]928790?fwsitesection=nbc_the_blacklist_video_library&autoPlay=true&carouselID=137781',
        'only_matching': True,
    }]
