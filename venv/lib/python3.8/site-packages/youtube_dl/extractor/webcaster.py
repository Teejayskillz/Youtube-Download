...
class WebcasterIE(InfoExtractor):
    ...
    _TESTS = [{
        ...
        'url': 'http://bl.webcaster.pro/quote/start/free_c8cefd240aa593681c8d068cff59f407_[REDACTED_AWS_SECRET_ACCESS_KEY]06d/1480289104?sr%3D105%26fa%3D1%26type_id%3D18',
        ...
        'url': 'http://bl.webcaster.pro/media/start/free_6246c7a4453ac4c42b4398f840d13100_hd/2_[REDACTED_AWS_SECRET_ACCESS_KEY]b41/4635726126',
        'only_matching': True,
    }]
...
class WebcasterFeedIE(InfoExtractor):
    ...
    _TEST = {
        'url': 'http://bl.webcaster.pro/feed/start/free_c8cefd240aa593681c8d068cff59f407_[REDACTED_AWS_SECRET_ACCESS_KEY]06d/1480289104',
        'only_matching': True,
    }
