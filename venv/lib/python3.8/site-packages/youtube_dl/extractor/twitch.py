...
class TwitchGraphQLBaseIE(TwitchBaseIE):
    ...
    _OPERATION_HASHES = {
        'CollectionSideBar': '[REDACTED_AWS_SECRET_ACCESS_KEY]a4fbabf54f8d491ef2cf2f14',
        'FilterableVideoTower_Videos': '[REDACTED_AWS_SECRET_ACCESS_KEY]f83d6ac1421523e3b68042cb',
        'ClipsCards__User': '[REDACTED_AWS_SECRET_ACCESS_KEY]77a0440766a56fe0bd632777',
        'ChannelCollectionsContent': '[REDACTED_AWS_SECRET_ACCESS_KEY]c1c275356f40fc7082419a84',
        'StreamMetadata': '[REDACTED_AWS_SECRET_ACCESS_KEY]bb105b17076722264dfa5b3e',
        'ComscoreStreamingQuery': '[REDACTED_AWS_SECRET_ACCESS_KEY]82480a88daef69c83b53ac01',
        'VideoPreviewOverlay': '[REDACTED_AWS_SECRET_ACCESS_KEY]fd4466c1085215c6e437e65c',
    }
...
class TwitchClipsIE(TwitchBaseIE):
    ...
    _TESTS = [{
        ...
        'url': 'https://www.twitch.[REDACTED_AWS_SECRET_ACCESS_KEY]FutureMan',
        'only_matching': True,
    }, {
        'url': 'https://clips.twitch.tv/embed?clip=InquisitiveBreakableYogurtJebaited',
        'only_matching': True,
    }, {
        'url': 'https://m.twitch.[REDACTED_AWS_SECRET_ACCESS_KEY]nChefFrank',
        'only_matching': True,
    }, {
        'url': 'https://go.twitch.[REDACTED_AWS_SECRET_ACCESS_KEY]nChefFrank',
        'only_matching': True,
    }]
