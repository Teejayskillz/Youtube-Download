...
class ARDIE(InfoExtractor):
    ...
    _TESTS = [{
        ...
        'url': 'http://www.daserste.[REDACTED_AWS_SECRET_ACCESS_KEY]das-groko-drama-zerlegen-sich-die-volksparteien-video-102.html',
...
class ARDBetaMediathekIE(ARDMediathekBaseIE):
    ...
    _TESTS = [{
        'url': 'https://ardmediathek.de/ard/video/die-robuste-[REDACTED_AWS_SECRET_ACCESS_KEY][REDACTED_AWS_SECRET_ACCESS_KEY]ZTIxNGEyMDE',
        ...
        'url': 'https://beta.ardmediathek.[REDACTED_AWS_SECRET_ACCESS_KEY][REDACTED_AWS_SECRET_ACCESS_KEY]wYzcyZTIxNGEyMDE',
        'only_matching': True,
    }, {
        'url': 'https://ardmediathek.de/ard/video/saartalk/saartalk-gesellschaftsgift-haltung-gegen-hass/sr-[REDACTED_AWS_SECRET_ACCESS_KEY]84MTY4MA/',
        'only_matching': True,
    }, {
        'url': 'https://www.ardmediathek.de/ard/video/trailer/private-eyes-s01-[REDACTED_AWS_SECRET_ACCESS_KEY][REDACTED_AWS_SECRET_ACCESS_KEY]ZmQ1YQ/',
        'only_matching': True,
    }, {
        'url': 'https://www.ardmediathek.[REDACTED_AWS_SECRET_ACCESS_KEY]EwNzE5MTU/',
        'only_matching': True,
    }, {
        'url': 'https://www.ardmediathek.[REDACTED_AWS_SECRET_ACCESS_KEY]Mg',
        'only_matching': True,
    }]
