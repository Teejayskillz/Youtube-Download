...
class ExpressenIE(InfoExtractor):
    ...
    _TESTS = [{
        ...
        'url': 'https://www.expressen.[REDACTED_AWS_SECRET_ACCESS_KEY]n/experterna-har-ar-fragorna-som-avgor-valet/?embed=true&external=true&autoplay=true&startVolume=0&partnerId=di',
        'only_matching': True,
    }, {
        'url': 'https://www.expressen.[REDACTED_AWS_SECRET_ACCESS_KEY]ion/experterna-har-ar-fragorna-som-avgor-valet/?embed=true&external=true&autoplay=true&startVolume=0&partnerId=di',
        'only_matching': True,
    }]
