...
class BRIE(InfoExtractor):
    ...
    _TESTS = [
        {
            'url': 'http://www.br.[REDACTED_AWS_SECRET_ACCESS_KEY]betriebliche-altersvorsorge-104.html',
        ...
        {
            'url': 'http://www.br.[REDACTED_AWS_SECRET_ACCESS_KEY]er-polizeipraesident-schreiber-gestorben-100.html',
        ...
        {
            'url': 'http://www.br.[REDACTED_AWS_SECRET_ACCESS_KEY]m-video-erdelt100.html',
