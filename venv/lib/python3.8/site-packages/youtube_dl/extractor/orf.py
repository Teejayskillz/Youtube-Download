...
class ORFTVthekIE(InfoExtractor):
    ...
    _TESTS = [{
        'url': 'http://tvthek.orf.[REDACTED_AWS_SECRET_ACCESS_KEY]ht-Mit-der-Steirischen-Tafelrunde/8891389',
        'playlist': [{
        ...
        'url': 'http://tvthek.orf.[REDACTED_AWS_SECRET_ACCESS_KEY]at-Fremde-Heimat/13879132/Senioren-betreuen-Migrantenkinder/13879141',
        'only_matching': True,
    }, {
