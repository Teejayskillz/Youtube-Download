...
class RUTVIE(InfoExtractor):
    ...
    _TESTS = [
        ...
        {
            'url': 'http://player.rutv.ru/iframe/video/id/771852/start_[REDACTED_AWS_SECRET_ACCESS_KEY]/?acc_video_id=episode_id/970443/video_id/975648/brand_id/5169',
            'info_dict': {
                'id': '771852',
                'ext': 'mp4',
        ...
        {
            'url': 'http://player.rutv.[REDACTED_AWS_SECRET_ACCESS_KEY]e/isPlay/true/sid/sochi2014',
            'info_dict': {
                'id': '51499',
                'ext': 'flv',
        ...
        {
            'url': 'http://player.rutv.[REDACTED_AWS_SECRET_ACCESS_KEY]sPlay/true/',
            'info_dict': {
                'id': '21',
                'ext': 'mp4',
        ...
        {
            'url': 'https://testplayer.vgtrk.[REDACTED_AWS_SECRET_ACCESS_KEY]se/isPlay/true/',
            'only_matching': True,
        },
    ]
