...
class YoutubeIE(YoutubeBaseInfoExtractor):
    ...
    _VALID_URL = r"""(?x)^
                     (
                         ...
                         (?:(?:(?:(?:\w+\.)?[yY][oO][uU][tT][uU][bB][eE](?:-nocookie|kids)?\.com/|
                            ...
                            (?:www\.)?[REDACTED_AWS_SECRET_ACCESS_KEY]4bzzsg2ii4fv2iid\.onion/|
                            (?:www\.)?[REDACTED_AWS_SECRET_ACCESS_KEY]eojqbgpea3xqjoid\.onion/|
                            (?:www\.)?[REDACTED_AWS_SECRET_ACCESS_KEY]mbqlkurlclmancad\.onion/|
                            (?:www\.)?invidious\.[REDACTED_AWS_SECRET_ACCESS_KEY]mlskqauz5pyuzgqd\.onion/|
                            (?:www\.)?[REDACTED_AWS_SECRET_ACCESS_KEY]4jhk3ej3i7ya\.b32\.i2p/|
                            (?:www\.)?[REDACTED_AWS_SECRET_ACCESS_KEY]2n7madpwopotugyd\.onion/|
    ...
    def _mark_watched(self, video_id, video_info, player_response):
        ...
        CPN_ALPHABET = '[REDACTED_AWS_SECRET_ACCESS_KEY]OPQRSTUVWXYZ0123456789-_'
...
class YoutubeLiveIE(YoutubeBaseInfoExtractor):
    ...
    _TESTS = [{
        ...
        'url': 'https://www.youtube.[REDACTED_AWS_SECRET_ACCESS_KEY]e',
        'only_matching': True,
    }, {
