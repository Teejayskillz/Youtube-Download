...
class ProSiebenSat1IE(ProSiebenSat1BaseIE):
    ...
    _TESTS = [
        ...
        {
            'url': 'http://www.prosieben.[REDACTED_AWS_SECRET_ACCESS_KEY]s/video-Lady-Umstyling-f%C3%BCr-Audrina-Rebekka-Audrina-Fergen-billig-aussehen-Battal-Modica-700544.html',
            'info_dict': {
                'id': '2570327',
                'ext': 'mp4',
