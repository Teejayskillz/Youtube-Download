...
class TwitterBaseIE(InfoExtractor):
    ...
    def _call_api(self, path, video_id, query={}):
        headers = {
            'Authorization': 'Bearer [REDACTED_AWS_SECRET_ACCESS_KEY]Mxqa8h%2F40K4moUkGsoc%[REDACTED_AWS_SECRET_ACCESS_KEY]GfsyKCs0wRbw',
        }
...
class TwitterIE(TwitterBaseIE):
    ...
    _TESTS = [{
        'url': 'https://twitter.[REDACTED_AWS_SECRET_ACCESS_KEY]480',
        'info_dict': {
        ...
        'url': 'https://twitter.[REDACTED_AWS_SECRET_ACCESS_KEY]o/1',
        ...
        'url': 'https://twitter.[REDACTED_AWS_SECRET_ACCESS_KEY]4880',
        'info_dict': {
            'id': '705235433198714880',
            'ext': 'mp4',
            'title': "Brent Yarina - Khalil Iverson's missed highlight dunk. And made highlight dunk. In one highlight.",
        ...
        'url': 'https://twitter.[REDACTED_AWS_SECRET_ACCESS_KEY]',
        'info_dict': {
        ...
        'url': 'https://twitter.[REDACTED_AWS_SECRET_ACCESS_KEY]0289',
        'info_dict': {
        ...
        'url': 'https://twitter.[REDACTED_AWS_SECRET_ACCESS_KEY]6656',
        'info_dict': {
            'id': '1vOGwqejwoWxB',
            'ext': 'mp4',
