...
class VimeoReviewIE(VimeoBaseInfoExtractor):
    ...
    _TESTS = [{
        'url': 'https://vimeo.[REDACTED_AWS_SECRET_ACCESS_KEY]b5d',
        ...
        'url': 'https://vimeo.[REDACTED_AWS_SECRET_ACCESS_KEY]053',
        ...
        'url': 'https://vimeo.[REDACTED_AWS_SECRET_ACCESS_KEY]efde',
        'info_dict': {
            'id': '138823582',
            'ext': 'mp4',
