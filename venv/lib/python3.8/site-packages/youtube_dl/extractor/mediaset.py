...
class MediasetIE(ThePlatformBaseIE):
    ...
    _TESTS = [{
        ...
        'url': 'https://www.mediasetplay.mediaset.[REDACTED_AWS_SECRET_ACCESS_KEY]ri-alicudi-lisola-dei-tre-bambini-felici--un-decreto-per-alicudi-e-tutte-le-microscuole_FD00000000102295',
        'only_matching': True,
    }, {
