...
class ArchiveOrgIE(InfoExtractor):
    ...
    _TESTS = [{
        'url': 'http://archive.org/details/XD300-23_[REDACTED_AWS_SECRET_ACCESS_KEY]t',
        'md5': '8af1d4cf447933ed3c7f4871162602db',
        'info_dict': {
            'id': 'XD300-23_[REDACTED_AWS_SECRET_ACCESS_KEY]t',
            'ext': 'ogg',
        ...
        'url': 'http://archive.org/embed/XD300-23_[REDACTED_AWS_SECRET_ACCESS_KEY]t',
        'only_matching': True,
    }]
