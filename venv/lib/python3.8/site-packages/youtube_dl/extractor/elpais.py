...
class ElPaisIE(InfoExtractor):
    ...
    _TESTS = [{
        ...
        'url': 'http://elcomidista.elpais.[REDACTED_AWS_SECRET_ACCESS_KEY]340311_668921.html#?id_externo_nwl=newsletter_diaria20160303t',
        ...
        'url': 'http://elpais.[REDACTED_AWS_SECRET_ACCESS_KEY]_417876.html',
