...
class GfycatIE(InfoExtractor):
    ...
    _TESTS = [{
        ...
        'url': 'https://gfycat.[REDACTED_AWS_SECRET_ACCESS_KEY]l',
        'only_matching': True
    }, {
        'url': 'https://gfycat.[REDACTED_AWS_SECRET_ACCESS_KEY]-baseball',
        'only_matching': True
    }, {
        'url': 'https://thumbs.gfycat.[REDACTED_AWS_SECRET_ACCESS_KEY]-size_restricted.gif',
        'only_matching': True
    }, {
        'url': 'https://giant.gfycat.[REDACTED_AWS_SECRET_ACCESS_KEY].mp4',
        'only_matching': True
    }]
