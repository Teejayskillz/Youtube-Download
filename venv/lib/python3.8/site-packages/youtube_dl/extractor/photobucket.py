...
class PhotobucketIE(InfoExtractor):
    ...
    _TEST = {
        'url': 'http://media.photobucket.[REDACTED_AWS_SECRET_ACCESS_KEY]uildingTryBacklinkMyDomaincom_zpsc0c3b9fa.mp4.html?filters[term]=search&filters[primary]=videos&filters[secondary]=images&sort=1&o=0',
