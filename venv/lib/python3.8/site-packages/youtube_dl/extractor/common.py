...
class InfoExtractor(object):
    ...
    def _parse_mpd_formats(self, mpd_doc, mpd_id=None, mpd_base_url='', formats_dict={}, mpd_url=None):
        ...
        References:
         1. MPEG-DASH Standard, ISO/IEC 23009-1:2014(E),
            http://standards.iso.[REDACTED_AWS_SECRET_ACCESS_KEY]274_ISO_IEC_23009-1_2014.zip
    ...
    def _parse_jwplayer_data(self, jwplayer_data, video_id=None, require_title=True,
        ...
        for video_data in jwplayer_data['playlist']:
            ...
            # https://github.[REDACTED_AWS_SECRET_ACCESS_KEY]/utils/validator.js#L32
    ...
    def _parse_jwplayer_formats(self, jwplayer_sources_data, video_id=None,
        ...
        for source in jwplayer_sources_data:
            ...
            # https://github.[REDACTED_AWS_SECRET_ACCESS_KEY]/providers/default.js#L67
                ...
                if source_url.startswith('rtmp'):
                    a_format['ext'] = 'flv'
                    # See [REDACTED_AWS_SECRET_ACCESS_KEY]iaProvider.as
