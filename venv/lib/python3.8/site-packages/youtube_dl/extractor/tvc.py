...
class TVCIE(InfoExtractor):
    ...
    _TEST = {
        'url': 'http://www.tvc.[REDACTED_AWS_SECRET_ACCESS_KEY]_stat/channel/?acc_video_id=[REDACTED_AWS_SECRET_ACCESS_KEY]de_id/39702',
...
class TVCArticleIE(InfoExtractor):
    ...
    _TESTS = [{
        'url': 'http://www.tvc.[REDACTED_AWS_SECRET_ACCESS_KEY]sode_id/39702/',
        'info_dict': {
            'id': '74622',
            'ext': 'mp4',
            'title': 'События. "События". Эфир от 22.05.2015 14:30',
