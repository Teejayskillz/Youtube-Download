...
class BBCCoUkIE(InfoExtractor):
    ...
    _TESTS = [
        ...
        },
        {
            ...
            'url': 'http://www.bbc.co.[REDACTED_AWS_SECRET_ACCESS_KEY]g-14-atchoo',
            'only_matching': True,
        }, {
                    ...
                    if supplier == 'asx':
                        ...
                        if protocol in ('http', 'https'):
                            ...
                            fmt.update({
                                ...
                                'player_url': 'http://www.bbc.co.[REDACTED_AWS_SECRET_ACCESS_KEY]_618125_4/617463_618125_4_emp.swf',
                                'rtmp_live': False,
                                'ext': 'flv',
                            })
                        else:
...
class BBCIE(BBCCoUkIE):
    ...
    _TESTS = [{
        ...
        'url': 'http://www.bbc.co.[REDACTED_AWS_SECRET_ACCESS_KEY]ohack/ep-181227',
        'info_dict': {
            'id': 'p06w9tws',
            'ext': 'mp4',
    ...
    def _real_extract(self, url):
        ...
        # http://www.bbc.co.[REDACTED_AWS_SECRET_ACCESS_KEY]ohack/ep-181227
...
class BBCCoUkArticleIE(InfoExtractor):
    ...
    _TEST = {
        'url': 'http://www.bbc.co.[REDACTED_AWS_SECRET_ACCESS_KEY]V6M2MS/not-your-typical-role-model-ada-lovelace-the-19th-century-programmer',
        'info_dict': {
...
class BBCCoUkPlaylistIE(BBCCoUkPlaylistBaseIE):
    ...
    _TESTS = [{
        ...
        'url': 'http://www.bbc.co.[REDACTED_AWS_SECRET_ACCESS_KEY]6',
        'only_matching': True,
    }, {
        'url': 'http://www.bbc.co.uk/programmes/b05rcz9v/clips',
        'only_matching': True,
