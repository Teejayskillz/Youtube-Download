...
class PBSIE(InfoExtractor):
    ...
    _TESTS = [
        ...
        {
            'url': 'http://www.pbs.[REDACTED_AWS_SECRET_ACCESS_KEY]player/',
            'info_dict': {
                'id': '2276541483',
                'display_id': 'player',
                'ext': 'mp4',
        ...
        {
            'url': 'https://player.pbs.[REDACTED_AWS_SECRET_ACCESS_KEY]==/',
            'info_dict': {
                'id': '3011407934',
                'ext': 'mp4',
    ...
    def _real_extract(self, url):
        ...
        if http_url:
            for m3u8_format in m3u8_formats:
                ...
                # 1. https://github.com/ytdl-org/youtube-[REDACTED_AWS_SECRET_ACCESS_KEY]a97b42d491#commitcomment-17313656
                # 2. https://projects.pbs.[REDACTED_AWS_SECRET_ACCESS_KEY]o+Specifications
