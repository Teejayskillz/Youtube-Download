...
class RtlNlIE(InfoExtractor):
    ...
    _TESTS = [{
        ...
        'url': 'http://www.rtl.[REDACTED_AWS_SECRET_ACCESS_KEY]ideo_embed.html#uuid=84ae5571-ac25-4225-ae0c-ef8d9efb2aed/autoplay=false',
        ...
        'url': 'http://www.rtl.[REDACTED_AWS_SECRET_ACCESS_KEY]ideo_embed.html#uuid=f536aac0-1dc3-4314-920e-3bd1c5b3811a/autoplay=false',
        'info_dict': {
