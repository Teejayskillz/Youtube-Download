...
class ZypeIE(InfoExtractor):
    ...
    _TEST = {
        'url': 'https://player.zype.com/embed/5b400b834b32992a310622b9.js?api_key=[REDACTED_AWS_SECRET_ACCESS_KEY]OHPLODgncEKVdPYBhuz9iWXQ&autoplay=false&controls=true&da=false',
