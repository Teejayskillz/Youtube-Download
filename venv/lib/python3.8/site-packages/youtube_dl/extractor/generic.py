...
class GenericIE(InfoExtractor):
    ...
    _TESTS = [
        ...
        # SMIL from http://new.livestream.[REDACTED_AWS_SECRET_ACCESS_KEY]4719370
        {
            'url': 'http://api.new.livestream.[REDACTED_AWS_SECRET_ACCESS_KEY]os/4719370.smil',
            'info_dict': {
                'id': '4719370',
                'ext': 'mp4',
        ...
        },
        {
            ...
            'url': 'https://www.facebook.com/l.php?u=https%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3DpO8h3EaFRdo&h=TAQHsoToz&enc=AZN16h-[REDACTED_AWS_SECRET_ACCESS_KEY]T_MFYkAA-WARTX2kvsCIdlAIyHZjl6d33ILIJU7Jzwk_K3mcenAXoAzBNoZDI_Q7EXGDJnIhrGkLXo_LJ_pAa2Jzbx17UHMd3jAs--6j2zaeto5w9RTn8T_[REDACTED_AWS_SECRET_ACCESS_KEY]lkw6pkS1-T&s=1',
            'info_dict': {
                'id': 'pO8h3EaFRdo',
                'ext': 'mp4',
        ...
        },
        {
            ...
            'add_ie': ['BrightcoveLegacy'],
            'url': 'http://www.kijk.[REDACTED_AWS_SECRET_ACCESS_KEY]XKAYan2S/aflevering-1',
            'info_dict': {
                'id': '3866516442001',
                'ext': 'mp4',
        ...
        # Camtasia studio
        {
            'url': 'http://www.ll.mit.[REDACTED_AWS_SECRET_ACCESS_KEY]ennas/lecture1/video/',
            'playlist': [{
        ...
        {
            'url': 'http://www.newyorker.[REDACTED_AWS_SECRET_ACCESS_KEY]-never-nuclear-command-and-control.html',
            'info_dict': {
                'id': 'always-never',
        ...
        {
            'url': 'http://www.premierchristianradio.[REDACTED_AWS_SECRET_ACCESS_KEY]ce-Videos/Os-Guinness-Is-It-Fools-Talk-Unbelievable-Conference-2014',
            'info_dict': {
                'id': '1_a52wc67y',
                'ext': 'flv',
        ...
        {
            'url': 'http://www.hudl.[REDACTED_AWS_SECRET_ACCESS_KEY]',
            'info_dict': {
        ...
        {
            'url': 'https://support.arkena.[REDACTED_AWS_SECRET_ACCESS_KEY]o',
        ...
        {
            # DBTV embeds
            'url': 'http://www.dagbladet.[REDACTED_AWS_SECRET_ACCESS_KEY]ver/43254897/',
            'info_dict': {
                'id': '43254897',
        ...
        {
            'url': 'https://www.yapfiles.[REDACTED_AWS_SECRET_ACCESS_KEY]a21bb3b1.mp4.html',
            'info_dict': {
