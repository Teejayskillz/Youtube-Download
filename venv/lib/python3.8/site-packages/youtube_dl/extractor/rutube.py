...
class RutubeIE(RutubeBaseIE):
    ...
    _TESTS = [{
        'url': 'http://rutube.[REDACTED_AWS_SECRET_ACCESS_KEY]e/',
        ...
        'url': 'http://rutube.[REDACTED_AWS_SECRET_ACCESS_KEY]e4c661',
        'only_matching': True,
    }, {
        'url': 'http://rutube.[REDACTED_AWS_SECRET_ACCESS_KEY]1',
        'only_matching': True,
    }, {
        'url': 'http://rutube.[REDACTED_AWS_SECRET_ACCESS_KEY]e/?pl_id=4252',
        'only_matching': True,
    }, {
        'url': 'https://rutube.[REDACTED_AWS_SECRET_ACCESS_KEY]b/?pl_type=source',
        'only_matching': True,
    }]
...
class RutubePlaylistIE(RutubePlaylistBaseIE):
    ...
    _TESTS = [{
        'url': 'https://rutube.[REDACTED_AWS_SECRET_ACCESS_KEY]6/?pl_id=3097&pl_type=tag',
        'info_dict': {
            'id': '3097',
        },
        'playlist_count': 27,
    }, {
        'url': 'https://rutube.[REDACTED_AWS_SECRET_ACCESS_KEY]b/?pl_id=4252&pl_type=source',
        'only_matching': True,
    }]
