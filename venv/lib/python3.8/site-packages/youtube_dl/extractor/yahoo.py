...
class YahooGyaOPlayerIE(InfoExtractor):
    ...
    _TESTS = [{
        'url': 'https://gyao.yahoo.co.[REDACTED_AWS_SECRET_ACCESS_KEY]564/',
        'info_dict': {
            'id': '5993125228001',
            'ext': 'mp4',
            'title': 'フューリー　【字幕版】',
        ...
        'url': 'https://streaming.yahoo.co.[REDACTED_AWS_SECRET_ACCESS_KEY]/',
        'only_matching': True,
    }, {
    ...
    def _real_extract(self, url):
        ...
        resp = self._download_json(
            'https://gyao.yahoo.co.jp/apis/playback/graphql', video_id, query={
                'appId': '[REDACTED_AWS_SECRET_ACCESS_KEY]c2VjcmV0Jng9NTk-',
                'query': '''{
...
class YahooJapanNewsIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        json_data = self._download_json(
            ...
            content_id,
            query={
                'appid': '[REDACTED_AWS_SECRET_ACCESS_KEY]c2VjcmV0Jng9YjU-',
                'output': 'json',
                'space_id': space_id,
                'domain': host,
