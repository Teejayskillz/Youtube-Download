...
class PacktPubIE(PacktPubBaseIE):
    ...
    _TESTS = [{
        'url': 'https://www.packtpub.com/mapt/video/web-[REDACTED_AWS_SECRET_ACCESS_KEY]oject+Intro',
        ...
        'url': 'https://subscription.packtpub.com/video/web_[REDACTED_AWS_SECRET_ACCESS_KEY]oject-intro',
        'only_matching': True,
    }, {
        'url': 'https://subscription.packtpub.[REDACTED_AWS_SECRET_ACCESS_KEY]ideo1_1/business-card-project',
        'only_matching': True,
    }]
