...
class MyviIE(SprutoBaseIE):
    _VALID_URL = r'''(?x)
                    ...
                    '''
    _TESTS = [{
        'url': 'http://myvi.[REDACTED_AWS_SECRET_ACCESS_KEY]_[REDACTED_AWS_SECRET_ACCESS_KEY]h8hQU0',
        ...
        'url': 'http://myvi.[REDACTED_AWS_SECRET_ACCESS_KEY]hD9_[REDACTED_AWS_SECRET_ACCESS_KEY]h8hQU0',
        'only_matching': True,
    }, {
        'url': 'http://myvi.tv/embed/html/oTGTNWdyz4Zwy_[REDACTED_AWS_SECRET_ACCESS_KEY]75x4_xxS9Vn0?ap=0',
        'only_matching': True,
    }, {
