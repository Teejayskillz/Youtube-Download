...
class SafariApiIE(SafariBaseIE):
    ...
    _TESTS = [{
        'url': 'https://www.safaribooksonline.[REDACTED_AWS_SECRET_ACCESS_KEY]rt00.html',
        'only_matching': True,
    }, {
        'url': 'https://www.safaribooksonline.[REDACTED_AWS_SECRET_ACCESS_KEY]CE_Introduction.html',
        'only_matching': True,
    }]
