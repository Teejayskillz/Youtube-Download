...
class CondeNastIE(InfoExtractor):
    ...
    _TESTS = [{
        ...
        # JS embed
        'url': 'http://player.cnevids.[REDACTED_AWS_SECRET_ACCESS_KEY]1d76261646d5566020000.js',
        ...
        'url': 'https://player.cnevids.[REDACTED_AWS_SECRET_ACCESS_KEY]5.js?target=js-cne-player',
        'only_matching': True,
    }, {
        'url': 'http://player-backend.cnevids.[REDACTED_AWS_SECRET_ACCESS_KEY]5.js',
        'only_matching': True,
    }]
