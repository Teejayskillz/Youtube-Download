...
class LinuxAcademyIE(InfoExtractor):
    _VALID_URL = r'''(?x)
                    ...
                    '''
    _TESTS = [{
        'url': 'https://linuxacademy.[REDACTED_AWS_SECRET_ACCESS_KEY]/2/module/154',
        'info_dict': {
            'id': '1498-2',
            'ext': 'mp4',
        ...
        'url': 'https://linuxacademy.[REDACTED_AWS_SECRET_ACCESS_KEY]/2',
        'only_matching': True,
    }, {
    ...
    def _login(self):
        ...
        def random_string():
            return ''.join([
                random.choice('[REDACTED_AWS_SECRET_ACCESS_KEY]fghijklmnopqrstuvwxyz-._~')
                for _ in range(32)])
