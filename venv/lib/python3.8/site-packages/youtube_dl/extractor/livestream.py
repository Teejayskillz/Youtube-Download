...
class LivestreamIE(InfoExtractor):
    ...
    _TESTS = [{
        'url': 'http://new.livestream.[REDACTED_AWS_SECRET_ACCESS_KEY]4719370',
        ...
        'url': 'https://new.livestream.[REDACTED_AWS_SECRET_ACCESS_KEY]7864563/player?autoPlay=false&height=360&mute=false&width=640',
        'only_matching': True,
    }, {
        'url': 'http://livestream.[REDACTED_AWS_SECRET_ACCESS_KEY]15',
        'only_matching': True,
    }]
