...
class ArkenaIE(InfoExtractor):
    ...
    _TESTS = [{
        ...
        'url': 'http://play.arkena.[REDACTED_AWS_SECRET_ACCESS_KEY]rkmatter/131064/?callbackMethod=jQuery1111002221189684892677_1469227595972',
        'only_matching': True,
    }, {
        'url': 'http://play.arkena.[REDACTED_AWS_SECRET_ACCESS_KEY]kmatter/131064/',
        'only_matching': True,
    }, {
    ...
    def _extract_url(webpage):
        # See https://support.arkena.[REDACTED_AWS_SECRET_ACCESS_KEY]o
        mobj = re.search(
