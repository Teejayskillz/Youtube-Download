...
class NprIE(InfoExtractor):
    ...
    _TESTS = [{
        'url': 'https://www.npr.[REDACTED_AWS_SECRET_ACCESS_KEY]05/new-music-from-beach-house-chairlift-cmj-discoveries-and-more',
        'info_dict': {
            'id': '449974205',
        ...
        'url': 'https://www.npr.[REDACTED_AWS_SECRET_ACCESS_KEY]/446928052/music-from-the-shadows-ancient-armenian-hymns-and-piano-jazz',
        'info_dict': {
            'id': '446928052',
