...
class NBAIE(TurnerBaseIE):
    ...
    _TESTS = [{
        'url': 'http://www.nba.[REDACTED_AWS_SECRET_ACCESS_KEY]53-okc-bkn-recap.nba/index.html',
        ...
        'url': 'http://www.nba.[REDACTED_AWS_SECRET_ACCESS_KEY]00276-nyk-cha-play5.nba/',
        'only_matching': True,
    }, {
        'url': 'http://watch.nba.[REDACTED_AWS_SECRET_ACCESS_KEY]041400301-cle-atl-recap.nba',
        ...
        'url': 'http://www.nba.com/timberwolves/wiggins-shootaround#',
        'info_dict': {
            'id': '[REDACTED_AWS_SECRET_ACCESS_KEY]-3462601',
            'ext': 'mp4',
            'title': 'Shootaround Access - Dec. 12 | Andrew Wiggins',
