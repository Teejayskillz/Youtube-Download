...
class NFLIE(InfoExtractor):
    ...
    _TESTS = [{
        ...
        'url': 'http://www.nfl.[REDACTED_AWS_SECRET_ACCESS_KEY]patriots-seahawks-involved-in-lategame-skirmish',
        'info_dict': {
            'id': '0ap3000000467607',
            'ext': 'mp4',
    ...
    def _real_extract(self, url):
        ...
        config_url = NFLIE.prepend_host(host, self._search_regex(
            ...
            webpage, 'config URL', default='[REDACTED_AWS_SECRET_ACCESS_KEY]g.json',
            group='config'))
